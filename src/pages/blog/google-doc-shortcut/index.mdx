...
date: 2020-11-08
description: Quickly create new Google dos using shortcuts `doc.new`, `sheet.new`, `slide.new`.
tag: tips
---
...
Then, one day, I was given a tip that changed my life. My friend and fellow developer Guilherme was on the call, and said "Next time, just go to [doc.new][2]". I thought, no, that black magic can't possibly exist.
...
The official Google support documentation for these shortcuts is [here][13], filed under "Beginner tips". Thanks Google for making me feel great.
